...
part of 'm_restaurant.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MRestaurant _$MRestaurantFromJson(Map<String, dynamic> json) => MRestaurant(
...
Map<String, dynamic> _$MRestaurantToJson(MRestaurant instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
